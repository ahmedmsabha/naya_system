...
export function StaffingSidebar({ branchId }: { branchId: string }) {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex flex-col w-[220px] shrink-0 bg-white border-l border-gray-100 h-full py-8 px-4 gap-1.5 shadow-[inset_1px_0_0_0_rgba(0,0,0,0.02)]">
